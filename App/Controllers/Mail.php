...
{
    public $senderemail = "noreply@glamgloballimited.com";
    public $sendername = APP_NAME;
    public $replytoemail = "noreply@glamgloballimited.com";
    ...
    public function sendemail()
    {
        ...
        try {
            ...
            $this->phpmailer->Host       = 'mail.glamgloballimited.com';                    // Set the SMTP server to send through
            $this->phpmailer->SMTPAuth   = true;                                   // Enable SMTP authentication
            $this->phpmailer->Username   = 'noreply@glamgloballimited.com';                     // SMTP username
